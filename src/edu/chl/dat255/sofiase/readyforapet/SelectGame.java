...
public class SelectGame extends Activity implements Serializable {// la till fˆr att objektet mÂste vara serializible
	//	private static final long serialVersionUID = 1L;
	TextView failMessage;
	//  String FILENAME = "pet_file.dat";// lgts till fˆr nullpointerexep
