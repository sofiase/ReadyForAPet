...
public class CreatePet extends Activity implements OnClickListener, Serializable { //lagt till interface serializivble. kanske inte nˆdv‰ndigt
	...
	//String FILENAME = "pet_file.dat";//lagts till fˆr nullpointerexeption
